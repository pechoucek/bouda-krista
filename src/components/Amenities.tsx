...
const icons = [
  ...
  // national park — mountain peaks
  <svg key="park" className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M1 20L9 5L14 13L17 8L23 20H1Z" /></svg>,
