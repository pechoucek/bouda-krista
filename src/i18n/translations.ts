...
const t = {
  cs: {
    ...
    book: {
      ...
      aboutLabel:  "Napište nám pár slov o sobě",
      aboutPlaceholder: "Kdo jste, proč jedete do hor, co od pobytu očekáváte…",
  ...
  en: {
    ...
    book: {
      ...
      aboutLabel:  "Tell us a few words about yourself",
      aboutPlaceholder: "Who are you, why are you heading to the mountains, what are you looking forward to…",
