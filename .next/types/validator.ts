...
// Validate ../../src/app/api/gopay-notify/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/gopay-notify">> = Specific
  const handler = {} as typeof import("../../src/app/api/gopay-notify/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
